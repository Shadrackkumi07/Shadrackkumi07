...
### 🚀 About Me
I’m a **Software Engineer** passionate about creating impactful, scalable applications — from end-to-end systems to intuitive user experiences.

I’m the creator and lead developer behind **[Brackify](https://brackify.gg)** — a global esports platform built with **React, Node.js, Python, and MongoDB**, now available on **Android & iOS**. Enriched with **AI-powered automation, analytics, and creator tools**.
